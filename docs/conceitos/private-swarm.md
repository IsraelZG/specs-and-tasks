...
*Lente de Visão relacionada:* [RFC — Camada de Transporte P2P §4.7.5](file:///c:/Dev2026/Docs/docs/rfc-transporte-p2p-v3.1.md#L614)
...
*Lente de Protocolo relacionada:* [RFC — Camada de Transporte P2P §4.7.1, §4.7.3](file:///c:/Dev2026/Docs/docs/rfc-transporte-p2p-v3.1.md#L579)
...
*Lente de SDK relacionada:* [RFC — Camada de Transporte P2P §4.7.2, §4.7.4](file:///c:/Dev2026/Docs/docs/rfc-transporte-p2p-v3.1.md#L590)
...
*Lente de Governança relacionada:* [RFC — Camada de Transporte P2P §4.7.5](file:///c:/Dev2026/Docs/docs/rfc-transporte-p2p-v3.1.md#L614)
