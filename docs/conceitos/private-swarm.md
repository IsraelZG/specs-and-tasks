...
*Lente de Visão relacionada:* [RFC — Camada de Transporte P2P §4.7.5](file:///c:/Dev2026/Docs/docs/caderno-5-transport/01-p2p-transport-and-reconciliation.md#L614)
...
*Lente de Protocolo relacionada:* [RFC — Camada de Transporte P2P §4.7.1, §4.7.3](file:///c:/Dev2026/Docs/docs/caderno-5-transport/01-p2p-transport-and-reconciliation.md#L579)
...
*Lente de SDK relacionada:* [RFC — Camada de Transporte P2P §4.7.2, §4.7.4](file:///c:/Dev2026/Docs/docs/caderno-5-transport/01-p2p-transport-and-reconciliation.md#L590)
...
*Lente de Governança relacionada:* [RFC — Camada de Transporte P2P §4.7.5](file:///c:/Dev2026/Docs/docs/caderno-5-transport/01-p2p-transport-and-reconciliation.md#L614)

## Aparições a consolidar
As definições e implementações de suporte originais a serem consolidadas sob este verbete canônico encontram-se em:
- `docs/caderno-5-transport/01-p2p-transport-and-reconciliation.md §4.7` ([RFC — Camada de Transporte P2P](file:///c:/Dev2026/Docs/docs/caderno-5-transport/01-p2p-transport-and-reconciliation.md#L575))
