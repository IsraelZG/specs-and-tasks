...
| D3 | **OmniRoute** | **Só extrair mecanismos** — NÃO rodar o serviço standing (coerente com ADR-0008/0009). Portar: fallback em tiers/circuit-breaker do registry de providers; engines de compressão que faltam (session-dedup, relevance). O proxy Headroom morre de vez. |
