...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-xl border border-[color:var(--ds-theme-border-subtle)]">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('[&_tr]:border-b bg-[color:var(--ds-theme-surface-subdued)]/20', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn('mt-4 text-xs text-[color:var(--ds-theme-content-muted)] pb-2', className)}
    {...props}
  />
));
