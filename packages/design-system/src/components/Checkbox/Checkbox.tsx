...
const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
  (
    ...
    // Keeps a real DOM ref locally (needed for the imperative `indeterminate`
    // set below) while still forwarding it to the caller, whether they passed
    // a callback ref or a ref object.
