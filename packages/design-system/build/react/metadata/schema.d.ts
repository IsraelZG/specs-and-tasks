...
export type ComponentType = 'interactive' | 'input' | 'display' | 'container' | 'navigation' | 'feedback' | 'layout';
...
export declare const defineMetadata: (meta: ComponentMetadata) => ComponentMetadata;
