...
export async function ed25519GenerateKeyPair(): Promise<{
  ...
  return { publicKey: publicKey as Ed25519PublicKey, privateKey: privateKey as Ed25519PrivateKey };
}
...
export async function ed25519Sign(
  ...
  return ed25519.sign(message, privateKey) as Ed25519Signature;
}
...
export async function aesGcmEncrypt(
  ...
  const nonce = c.getRandomValues(new Uint8Array(12)) as AesNonce;
...
export async function sha256(data: Uint8Array): Promise<Sha256Digest> {
  return nobleSha256(data) as Sha256Digest;
}

// === Blake2s-256 ===

export async function blake2s256(data: Uint8Array): Promise<Uint8Array> {
  return blake2s(data);
}
