...
> **Atualizado automaticamente.** Agentes: não editem este arquivo. Usem `manage-task.mjs` para atualizar status.

| ID | Título | Status | Agente Alocado | Complexidade |
|---|---|---|---|---|
| [006-06](./006-06.md) | Aresta HAS_THEME: novo tipo de aresta CONTENT:THEME para PROFILE | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [006-07](./006-07.md) | Versionamento de tema por SUPERSEDED_BY: edicao gera novo no preservando reprodutibilidade | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [007-03](./007-03.md) | Semantica CRDT (LWW + Vector Clocks) para disputas de espelho Classe D | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [008-02](./008-02.md) | Notacao ZEN $doc.title para reagir a mutations do CRDT (sessao-doc/Automerge) | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [009-01](./009-01.md) | Ancora Merchant-of-Record (MoR): papeis declaraveis vs enumerados | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [009-02](./009-02.md) | Hard Stop Workflow: modo de regra blocking que trava transicao legal | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [014-04](./014-04.md) | Conector nativo de assinatura por Hard Token (A1/A3, PkiBrazil/Smartcard) | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [018-03](./018-03.md) | E2E em grupos grandes: limiar para Sender Keys/Group Ratchets | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [021-10](./021-10.md) | Aresta LOCATED_AT: Perfil/Evento/Empresa para coordenada | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [023-01](./023-01.md) | IA Julgadora Neutra (compute RAG) para disputa de escrow | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [023-02](./023-02.md) | Wave-picking com Zen sobre bins: deposito como subtipo SPEC:PLACE | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [024-15](./024-15.md) | UIs pesadas/iframe como filhos temporarios da arvore virtual SPEC:PAGE | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [025-09](./025-09.md) | Aresta INCLUDES: midia do Media Plane para SPEC:PAGE | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [027-01](./027-01.md) | Derivacao de sub-chaves do Usuario-Pai (Keychain) sem aprovacao interativa | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [027-04](./027-04.md) | Aresta DELEGATES_TO: Mestre para Modulo, tensao com DELEGATED_TO existente | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [C-01](./C-01.md) | Cleanup: protocol (19 não-bloqueantes) | `done` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [C-02](./C-02.md) | Cleanup: core (23 não-bloqueantes) | `done` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [C-03](./C-03.md) | Cleanup: transport (11 não-bloqueantes) | `done` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [C-04](./C-04.md) | Cleanup: bancada (9 não-bloqueantes) | `done` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [C-05](./C-05.md) | Cleanup: control (7 não-bloqueantes) | `done` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [C-06](./C-06.md) | Cleanup: showcase (5 não-bloqueantes) | `done` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
...
| [L-01](./L-01.md) | Ressurreicao de deadline P2P: publicacao duravel de timers workflow se peer cai | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [L-02](./L-02.md) | k-anonimato na segmentacao: invariante de coorte minimo (k-anonymity) | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [L-03](./L-03.md) | MoR + hard-stop legal: Merchant of Record e modo de bloqueio rigido | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [O-01](./O-01.md) | Colisao slot 09 do caderno-3: design-system vs hierarchical-theme — decidir numeracao | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [O-02](./O-02.md) | Colisao slot 22 do caderno-3: Mapa vs Workflow — mapa unico de numeracao | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
...
| [ORQ-04](./ORQ-04.md) | orquestrar.mjs spawn real — registry + lock + prompt assembly + --on-finish + circuit breaker | `done` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 6 |
| [ORQ-05](./ORQ-05.md) | Propaga o hook --on-finish do orquestrador no passo final de cada skill MGTIA | `done` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [ORQ-06](./ORQ-06.md) | Painel unificado :8780 (headrooms + dispatch + instâncias + ledger + saldos) + cloudflared | `done` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [ORQ-07](./ORQ-07.md) | UI na nuvem (Lovable/Vercel) + agente local via WebSocket outbound — acesso remoto modelo B | `done` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 6 |
| [ORQ-08](./ORQ-08.md) | SPIKE: AgentAdapter in-process (Vercel AI SDK) — ADR + PoC que roda 1 task end-to-end sem terminal | `done` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 6 |
...
| [ORQ-10](./ORQ-10.md) | Observabilidade + controle: stream de eventos ao vivo no painel + cancelar/matar instancia + deteccao de travada | `ready` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
...
| [ORQ-12](./ORQ-12.md) | SPIKE: Otimização de contexto no AgentAdapter — Headroom CCR in-process + nano-preprocess (ADR + números reais) | `in_progress` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
...
| [T-004a](./T-004a.md) | Adapter SQLite concreto do StoragePort (WAL, exec/transaction/migrate, wal_checkpoint) | `done` | core_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-004b](./T-004b.md) | Adapter SQLite WASM/OPFS do StoragePort (browser/local-first) | `in_progress` | core_agent | 4 |
| [T-005](./T-005.md) | SimNetwork v1 | `done` | logic_agent | 3 |
| [T-006](./T-006.md) | SimNetwork v2 — Degradação e NAT | `done` | logic_agent | 3 |
| [T-006a](./T-006a.md) | SimNetwork v2: degradação (drop/latência/jitter/bandwidth) | `done` | logic_agent | 3 |
| [T-006b](./T-006b.md) | SimNetwork v2: perfis NAT (open/cone/symmetric) | `done` | logic_agent | 2 |
...
| [T-018b](./T-018b.md) | Testes — Tier A batch 2 (8 interativos) | `done` | frontend_agent | 2 |
| [T-018c](./T-018c.md) | Testes — Tier B overlays (8 disclosure) | `done` | frontend_agent | 2 |
| [T-018d](./T-018d.md) | Testes — Tier C batch 1 (8 display/estrutural) | `done` | frontend_agent | 1 |
...
| [T-1022](./T-1022.md) | Runner: AgentAdapter (interface + CommandAdapter genérico) | `done` | devops_agent | 3 |
| [T-1023](./T-1023.md) | Runner core: loop serial supervisionado (worker→gate→reviewer→rework) | `done` | logic_agent | 4 |
| [T-1024](./T-1024.md) | Worktree pool: reuso de worktrees longevas com node_modules quente (gatilho: concorrência) | `ready` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
...
| [T-1028](./T-1028.md) | State machine: in_review + draft:<sub> + verbos de endurecimento | `done` | logic_agent | 5 |
| [T-1029](./T-1029.md) | TaskService side-effects: trava-decomposto + autoPromoteDependents + auto-close-pai | `done` | logic_agent | 4 |
| [T-103](./T-103.md) | HLC (Hybrid Logical Clock) completo | `done` | logic_agent | 3 |
| [T-1030](./T-1030.md) | Migracao do eixo spec_status para draft:<sub> + consumidores (ledger/hardening/generate) | `done` | logic_agent | 4 |
| [T-1031](./T-1031.md) | Skills e docs: alinhar ao novo ciclo de vida MGTIA | `done` | logic_agent | 3 |
| [T-1032](./T-1032.md) | Enforcement de sync dirigido por UCAN no responder RBSR | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-1034](./T-1034.md) | Hardening do wire RBSR exchange: filtro por peerId, ClockPort, encoding | `in_progress` | protocol_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
| [T-1035](./T-1035.md) | Hardening de secrets do system-peer: admin token timing-safe e sem log | `done` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [T-1036](./T-1036.md) | KeyVault: validar UCAN real em requestEpochKey (API de rede) e cópia defensiva | `done` | crypto_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [T-1036.1](./T-1036.1.md) | Integration: wire requestEpochKey to a production caller | `ready` | devops_agent | 2 |
| [T-1037](./T-1037.md) | DECISÃO: agnosticismo de engine de storage — StoragePort SQL-shaped vs query-model (NoSQL-ready) | `done` | core_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [T-1038](./T-1038.md) | Absorver RFC plugin-blueprint: archetypes filesystem/MCP/LSP/agent-runner no caderno-3/12 + resolver conflito Automerge×Y.js | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
...
| [T-1042](./T-1042.md) | Migrar o adapter SQLite atual para GraphStorePort | `rework` | core_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
...
| [T-1045](./T-1045.md) | Formalizar camada de projecao sobre o query-model | `in_review` | core_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
...
| [T-111](./T-111.md) | Bancada: aba Identidade | `done` | frontend_agent | 2 |
...
| [T-206](./T-206.md) | Heartbeat implícito/explícito + evicção | `done` | core_agent | 3 |
| [T-207](./T-207.md) | RelayTrustModel v0 | `done` | transport_agent | 3 |
| [T-208](./T-208.md) | First Peer Protocol (FPP) | `done` | logic_agent | 4 |
| [T-209](./T-209.md) | Gênese gerida | `done` | backend_agent | 3 |
| [T-210](./T-210.md) | Convite ASSET:INVITE | `done` | logic_agent | 4 |
| [T-211](./T-211.md) | Bancada: aba Rede | `done` | frontend_agent | 2 |
...
| [T-304](./T-304.md) | ConcurrentReconciliationGuard | `done` | core_agent | 4 |
...
| [T-309](./T-309.md) | GlobalThrottle | `ready` | core_agent | 3 |
...
| [T-313](./T-313.md) | Archive Cargo | `ready` | core_agent | 5 |
| [T-313a](./T-313a.md) | Archive Cargo: pack/unpack/verify (zstd + AES-256-GCM + blake2s256) | `done` | core_agent | 3 |
| [T-313b](./T-313b.md) | Archive Cargo: assignCustodian (consistent hashing sobre blind_scope_id) | `done` | core_agent | 2 |
| [T-313c](./T-313c.md) | Archive Cargo: GC + migration blind_archives (storage ops) | `done` | core_agent | 2 |
| [T-401](./T-401.md) | Signaling no peer do sistema | `done` | backend_agent | 4 |
...
| [T-804](./T-804.md) | Cloud WebSeed + Edge translation | `in_review` | backend_agent | 4 |
...
| [T-905](./T-905.md) | Documentação de integração + ADRs | `ready` | devops_agent | 3 |
| [T-9997](./T-9997.md) | PROBE 2: simulate C-01 cleanup | `done` | logic_agent | 2 |
...
| [T-CN-04](./T-CN-04.md) | persona agente-de-sistema por conector com ASSET:ROLE escopado + vetor | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-DS-01](./T-DS-01.md) | importar pacote de tokens + build multi-plataforma (Style Dictionary) | `ready` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
| [T-DS-02](./T-DS-02.md) | importar schema de metadados AI-ready + indice + CI | `draft:triaged` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
| [T-DS-03](./T-DS-03.md) | portar componentes-piloto para core/design-system consumindo tokens semanticos | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-DS-04](./T-DS-04.md) | lint anti-literal (invariante I3) | `draft:triaged` | devops_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
| [T-DS-05](./T-DS-05.md) | Identidade visual: paleta + accent por módulo + escalas (raio/borda/elevação) + claro/escuro | `ready` | frontend_agent | 5 |
...
| [T-IA-04](./T-IA-04.md) | persona de agente com ASSET:ROLE delegado + geracao de SPEC:PAGE validada | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-IA-05](./T-IA-05.md) | classificacao de intencao da command palette (busca/acao/geracao) + render progressivo | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-IA-06](./T-IA-06.md) | vetores: agente acima do escopo, recuperacao furando bloqueio, embedding restrito para external, fato superado | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 3 |
| [T-JU-01](./T-JU-01.md) | resolucao de jurisdicao efetiva (cascata) + registro no fato + testes de precedencia | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-JU-02](./T-JU-02.md) | composicao base+variante por EXTENDS + validacao variante nao contradiz invariante + degradacao para base | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-JU-03](./T-JU-03.md) | selecao por vigencia na competencia + recalculo retroativo + vetor (regra errada nunca aplicada) | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-JU-04](./T-JU-04.md) | resolucao multi-jurisdicao por ancora de papel (origem/destino/prestacao/titular) + provisao dupla + vetor cross-border | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [T-LOG-01](./T-LOG-01.md) | WMS: operacoes de armazem como SPEC:WORKFLOW + enderecamento + inventario ciclico | `draft:triaged` | logic_agent | 4 |
| [T-LOG-02](./T-LOG-02.md) | fulfillment: alocacao multi-deposito por Zen + reserva por LOCK + ciclo com compensacao | `draft:triaged` | logic_agent | 5 |
...
| [T-MK-04](./T-MK-04.md) | SPENDS/CREDITS com split multi-destino + comissao/imposto por SPEC + multi-moeda | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [T-MK-04a](./T-MK-04a.md) | SPENDS: dedução atômica de saldo com referência causal | `draft:triaged` | logic_agent | 3 |
...
| [T-MOD-04](./T-MOD-04.md) | vetores: delegado lendo dado de outro usuario, comando acima do privilegio, sessao efemera sem opt-in | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 2 |
| [T-MSG-01](./T-MSG-01.md) | envoltorio sobre o chat existente + integracao com DM social | `draft:triaged` | logic_agent | 3 |
| [T-MSG-02](./T-MSG-02.md) | chamadas/conferencia via LiveKit (SDK embutido + SFU plugin) + gravacao consolidada | `draft:triaged` | frontend_agent | 4 |
| [T-MSG-03](./T-MSG-03.md) | presenca efemera nao-replicada + vetores | `draft:triaged` | frontend_agent | 3 |
| [T-OFF-01](./T-OFF-01.md) | perfis de capacidade no motor de paginas + validador por perfil (emenda spec de paginas) | `draft:triaged` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-OFF-02](./T-OFF-02.md) | doc perfil documento (blocos, Automerge, backlinks) + markdown simples | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
...
| [T-PG-04](./T-PG-04.md) | sub-dialeto de formularios sobre dataschema de SPEC | `draft:triaged` | frontend_agent | 4 |
| [T-PG-05](./T-PG-05.md) | vetores: componente fora do catalogo, expressao estourando orcamento, intent acima do privilegio | `draft:triaged` | logic_agent | 3 |
| [T-PL-01](./T-PL-01.md) | SPEC:PLUGIN + manifesto + verificacao de assinatura/listagem no loader | `ready` | logic_agent | 4 |
| [T-PL-02](./T-PL-02.md) | sandbox browser (Worker/WASM, sem autoridade ambiente) + bridge de componente | `draft:triaged` | frontend_agent | 5 |
| [T-PL-03](./T-PL-03.md) | sandbox node (processo/isolate, capacidades por ASSET:ROLE) | `draft:triaged` | devops_agent | 5 |
| [T-PL-04](./T-PL-04.md) | ComputePort + escalonador com anuncio de runtime via serves + casamento de site | `draft:triaged` | logic_agent | 4 |
| [T-PL-05](./T-PL-05.md) | fila assincrona (task=no, claim por ASSET:LOCK, resultado assinado, idempotencia) | `draft:triaged` | logic_agent | 4 |
| [T-PL-05a](./T-PL-05a.md) | Fila assíncrona: claim por ASSET:LOCK + lease com heartbeat | `draft:triaged` | logic_agent | 3 |
| [T-PL-05b](./T-PL-05b.md) | Fila assíncrona: resultado assinado + idempotência | `draft:triaged` | logic_agent | 2 |
| [T-PL-06](./T-PL-06.md) | vetores: bundle nao-listado, plugin com rede fora das portas, classe restrita para external | `draft:triaged` | logic_agent | 3 |
| [T-POL-01](./T-POL-01.md) | Polish: T-007 testkit (m1 código morto, m2 diff custom, m3 mensagem sem fingerprints) | `ready` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 1 |
| [T-POL-02](./T-POL-02.md) | Polish: T-010 system-peer (dead vi import, header redundante) | `ready` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 1 |
| [T-POL-03](./T-POL-03.md) | Polish: T-203 codec (caso 7 do codec.test.ts não cobre o byte 0xc1 da spec) | `ready` | logic_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 1 |
| [T-SHL-01](./T-SHL-01.md) | shell FlexLayout + SPEC:WORKSPACE (default + salvos nomeados) + painel binda (modulo+pagina+params) | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [T-SHL-02](./T-SHL-02.md) | restricoes de layout no manifesto + gerenciador deterministico (recencia+pinos) + pilha de colapsados | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-SHL-03](./T-SHL-03.md) | responsividade continua (multi-coluna para mobile) + chrome-como-modulo (menu reposicionado) | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-SHL-04](./T-SHL-04.md) | drag/share como mensagem de comando + contrato de aceite + falha controlada; rota + deep-link | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-SHL-05](./T-SHL-05.md) | camada de overlay + command palette (superficie) + ciclo de vida de painel (suspensao) | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-SOC-01](./T-SOC-01.md) | SPECs de perfil/post/story + arestas sociais + visibilidade publica/privada | `ready` | logic_agent | 4 |
| [T-SOC-02](./T-SOC-02.md) | feed via SuperCard/Layout + ranking Zen + RRF + slot de anuncio | `draft:triaged` | frontend_agent | 4 |
| [T-SOC-03](./T-SOC-03.md) | vetores: privacidade retroativa e bloqueio como limites, story expirado, contadores como projecao | `draft:triaged` | frontend_agent | 3 |
| [T-STR-01](./T-STR-01.md) | SPECs de conteudo/canal/colecao + reproducao adaptativa sobre o media plane | `ready` | logic_agent | 4 |
| [T-STR-02](./T-STR-02.md) | renditions como utilitario compute assincrono + irmaos CONTENT | `draft:triaged` | devops_agent | 4 |
| [T-STR-03](./T-STR-03.md) | live via LiveKit (SDK embutido + SFU plugin) + consolidacao para CONTENT:FILE | `draft:triaged` | frontend_agent | 4 |
| [T-STR-04](./T-STR-04.md) | monetizacao (assinatura/PPV/ads/tip) + repasse por SPEC + vetor sem-seeder | `draft:triaged` | logic_agent | 4 |
| [T-UI-01](./T-UI-01.md) | categoria ui no modelo de plugins + manifesto (props/intents/capacidades) — estende T-PL-01 | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-UI-02](./T-UI-02.md) | host de sandbox (iframe + Worker/OffscreenCanvas, bridge postMessage, orcamento, brokering) | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [T-UI-03](./T-UI-03.md) | componente rico GameEngine (2D/3D) data-driven com pontos ZEN + emissao de intent | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 5 |
| [T-UI-04](./T-UI-04.md) | tier estrito de validacao + vetores (DOM externo/rede nao declarada, intent acima do privilegio) | `draft:triaged` | frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent | 4 |
| [T-WF-01](./T-WF-01.md) | formato SPEC:WORKFLOW Nivel 1 + validador + envelope (guardas Zen, acoes intent, orcamento) | `ready` | logic_agent | 4 |
| [T-WF-02](./T-WF-02.md) | interpretador Nivel 1 (estado unico, transicao evento+guarda, entry/exit, timers HLC) event-sourced | `draft:triaged` | logic_agent | 5 |
| [T-WF-02a](./T-WF-02a.md) | Interpretador Nível 1: estado único + transição evento+guarda | `draft:triaged` | logic_agent | 3 |
| [T-WF-02b](./T-WF-02b.md) | Interpretador Nível 1: timers HLC + entry/exit actions | `draft:triaged` | logic_agent | 3 |
| [T-WF-03](./T-WF-03.md) | integracao com saga/TTL (compensacao) e tarefa humana (APPROVED_BY) | `draft:triaged` | logic_agent | 4 |
| [T-WF-04](./T-WF-04.md) | geracao Mermaid + read view na suite office | `draft:triaged` | frontend_agent | 3 |
| [T-WF-05](./T-WF-05.md) | vetores: guarda fora do registro, acao acima do privilegio, estado nunca mutavel-replicado, orcamento estourado aborta | `draft:triaged` | logic_agent | 3 |
