---
id: T-ERP-06
title: "UI do ERP/CRM (ordens, estoque multi-depósito com LOCK/TTL, pipeline kanban, visão 360, dashboard)"
status: draft:placeholder
complexity: 5
target_agent: frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent
reviewer_agent: agile_reviewer
execution_mode: sequential # parallel | sequential
dependencies: ["T-ERP-01", "T-ERP-02", "T-ERP-04", "T-SHL-01", "T-PG-02"] # IDs de tarefas que bloqueiam esta
ui: true
...
# T-ERP-06 · UI do ERP/CRM (ordens, estoque multi-depósito com LOCK/TTL, pipeline kanban, visão 360, dashboard)
...
## 1. Objetivo
Construir a UI do ERP/CRM sobre T-ERP-01/02/04: pedidos de venda/compra, estoque multi-depósito
com os **3 estados visuais do LOCK** (livre / reservado com TTL / expirado com alerta), pipeline
CRM em kanban, visão 360 do cliente (traversal), contas a pagar/receber, conciliação e dashboard
analítico. Renderiza na coluna central do shell via motor de páginas.

## 2. Contexto RAG (Spec-Driven Development)
- [mecanica-de-telas.md §B3](../docs/mecanica-de-telas.md) — mecânica validada no mockup: estoque agrupado por SKU→depósitos, TTL Lock e reserva expirada, recálculo como estado transitório não-bloqueante. Financeiro/Conciliação NÃO foram mockados — mecânica a definir no endurecimento.
- [mecanica-de-telas.md §T1/§T2](../docs/mecanica-de-telas.md) — assistente IA preenche ordem a partir de texto livre (proposta); `marketplace:order` e `email:message` são payloads aceitos (criar pendência/ordem).
- [inventario-de-telas.md §B3](../docs/inventario-de-telas.md) — composição exigida (modais: nova ordem, reserva LOCK, conciliar, mover etapa; estados: reserva expirada, projeção recalculando, limite de custo).
