...
# T-BW-02 · Bancada: Sync real — useSyncStatus sobre RBSR/SyncCoordinator
...
## 1. Objetivo
Ligar `apps/bancada/src/hooks/useSyncStatus.ts` (hoje stub declarado: "a integração real com
RBSRSession será feita em task futura") ao caminho real de reconciliação: sessão RBSR via
SyncCoordinator com transferência de nós reais (T-1046) e UCAN escopado (T-1032). A aba Sync
(T-311) passa a exibir root fingerprints/ondas REAIS de dois peers convergindo via system-peer.

## 2. Contexto RAG (Spec-Driven Development)
- [ ] T-1046 (transferência SignedNode real)
- [ ] T-1032 (enforcement UCAN)
- [ ] T-311 (aba Sync — UI pronta)
- [ ] plano §6 marco demo M3
