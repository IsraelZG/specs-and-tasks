---
id: T-CFG-01
title: "UI de Configurações & Conta (geral, ThemeEditor 4 níveis, rede/peers, telemetria, notificações, permissões)"
status: draft:placeholder
complexity: 4
target_agent: frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent
reviewer_agent: agile_reviewer
execution_mode: sequential # parallel | sequential
dependencies: ["T-SHL-01", "T-903", "T-504", "T-DS-05"] # IDs de tarefas que bloqueiam esta
ui: true
...
# T-CFG-01 · UI de Configurações & Conta (geral, ThemeEditor 4 níveis, rede/peers, telemetria, notificações, permissões)
...
## 1. Objetivo
Construir a superfície de Configurações do app produto: Geral (conta, idioma 6 locales+RTL, tema
claro/escuro, densidade, acessibilidade: alto contraste + reduzir movimento), ThemeEditor
hierárquico 4 níveis (app→módulo→página→componente) com **preview isolado** (nunca aplica direto),
Rede (status P2P + peers), Telemetria (RTT/bytes-por-onda/WAL + exportar — dados de T-903),
Central de notificações, e o gerenciador de Permissões & Bloqueios (revogação com aviso de
cortesia — backend T-504).

## 2. Contexto RAG (Spec-Driven Development)
- [mecanica-de-telas.md §A4 + §A3](../docs/mecanica-de-telas.md) — mecânica validada no mockup (tabs, ThemeEditor com preview isolado, peers, telemetria, notificações marcar-lido; tabela de permissões + revogação por cortesia + bloqueios). Decisão de copy pendente do acesso negado registrada no §A3.
- [inventario-de-telas.md §A4/§A3](../docs/inventario-de-telas.md) — composição exigida.
- [caderno-3-sdk/09-hierarchical-theme-customization.md](../docs/caderno-3-sdk/09-hierarchical-theme-customization.md) — modelo de dados do tema hierárquico.
