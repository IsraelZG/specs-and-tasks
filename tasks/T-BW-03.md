...
# T-BW-03 · Bancada: Auth real — AuthTab sobre UCAN/KeyVault reais (fim do mock)
...
## 1. Objetivo
Remover o `// mock UCAN state for E2E testing` do App.tsx: a aba Auth (T-512, UI pronta)
passa a consumir UCANs REAIS emitidos/validados por `packages/core/src/auth/ucan.ts` (T-501) e o
KeyVault real (negativa de chave observável). Playwright de T-512 re-apontado para o fluxo real.

## 2. Contexto RAG (Spec-Driven Development)
- [ ] T-501 (UCAN core)
- [ ] T-512 (aba Auth — UI pronta)
- [ ] T-110/T-1036 (KeyVault + requestEpochKey)
