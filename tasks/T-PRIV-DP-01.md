...
- [ ] `docs/implementation_plan.md` L-02 — Alternativa 2 (obfuscação diferencial) e trade-offs
- [ ] `tasks/L-02.md` — decisão que escalou este spike (Seção 6)
- [ ] `docs/caderno-3-sdk/29-anuncios-reference-spec.md` — k-anonimato na segmentação (o mecanismo que este spike complementa)
- [ ] `docs/conceitos/anuncio.md` — coorte mínimo
