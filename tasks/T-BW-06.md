---
id: T-BW-06
title: "Bancada: E2E integrado sem mocks (fluxo 2 peers + system-peer)"
status: draft:triaged
complexity: 4
target_agent: frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent
reviewer_agent: agile_reviewer
execution_mode: sequential # parallel | sequential
dependencies: ["T-BW-01", "T-BW-02", "T-BW-03", "T-BW-05", "T-608a"]
...
# T-BW-06 · Bancada: E2E integrado sem mocks (fluxo 2 peers + system-peer)
...
## 1. Objetivo
Prova de fechamento Core+Bancada: E2E Playwright multi-context SEM mocks — 2 browser contexts +
system-peer real; cenário: criar identidade → conectar → criar nós em A → convergir em B (RBSR real)
→ derrubar cloud → reconectar → anti-entropy O(1) (marco demo M3 do plano). Falha se qualquer aba
exibir dado de stub (asserção anti-mock: grep de marcadores "placeholder"/"mock" no bundle é gate).

## 2. Contexto RAG (Spec-Driven Development)
- [ ] plano §6 marco demo M3
- [ ] T-021 (arcabouço E2E compartilhado)
- [ ] todas as T-BW-*
