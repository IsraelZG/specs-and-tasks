---
id: T-LOG-06
title: "UI de Logística (WMS, fulfillment com saga, app do entregador, disputa/escrow)"
status: draft:placeholder
complexity: 5
target_agent: frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent
reviewer_agent: agile_reviewer
execution_mode: sequential # parallel | sequential
dependencies: ["T-LOG-01", "T-LOG-02", "T-LOG-04", "T-SHL-01", "T-PG-02"] # IDs de tarefas que bloqueiam esta
ui: true
...
# T-LOG-06 · UI de Logística (WMS, fulfillment com saga, app do entregador, disputa/escrow)
...
## 1. Objetivo
Construir a UI de Logística sobre T-LOG-01/02/04: WMS (operações de armazém, endereçamento,
inventário cíclico), fulfillment com as três filas (aguardando/em andamento/concluídas+disputas) e
saga aguardando→alocado→em rota→entregue, **"sem entregadores" como estado de primeira classe**
que bloqueia alocar, app do entregador (fila, navegação, prova de entrega), disputa com escrow
retido e surge/repasse.

## 2. Contexto RAG (Spec-Driven Development)
- [mecanica-de-telas.md §B6](../docs/mecanica-de-telas.md) — mecânica validada no mockup (filas, saga com mesmo vocabulário do §B2, sem-entregadores honesto, escrow "retido até resolução", surge). WMS fino, rastreio ao vivo e cotação/etiqueta NÃO foram mockados — definir no endurecimento.
- [mecanica-de-telas.md §T2](../docs/mecanica-de-telas.md) — `marketplace:order` como payload aceito (criar/vincular entrega); localização do entregador segue o padrão efêmero do §B5.
- [inventario-de-telas.md §B6](../docs/inventario-de-telas.md) — composição exigida.
