...
- [Referências locais](../docs/referencias-codigo-aberto.md) — Dashi em `docs/_vendor/dashi-ppt-skill`, commit fixado; ler `SKILL.md`, catálogo/layouts e scripts de validação como inspiração clean-room.
