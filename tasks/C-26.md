...
- [ ] `apps/estaleiro/ui/src/views/cost/CostView.test.tsx` — teste existente de Cost
- [ ] `apps/estaleiro/ui/src/views/fleet/AgentTerminal.tsx` — novo terminal de agente
- [ ] `apps/estaleiro/ui/tests/smoke.test.ts` — smoke tests

## 3. Escopo de Arquivos (Inputs e Outputs)
- **[UPDATE]** `apps/estaleiro/ui/tests/ws-client.test.ts` — reaproveitar WebSocketServer
- **[UPDATE]** `apps/estaleiro/ui/src/views/cost/CostView.test.tsx` — parar de mockar hook inteiro
- **[CREATE]** `apps/estaleiro/ui/src/views/fleet/__tests__/AgentTerminal.test.tsx` — 1-2 testes de smoke
- **[CREATE]** `apps/estaleiro/ui/tests/execution/WorkflowTree.test.tsx` — render com currentNodeId
