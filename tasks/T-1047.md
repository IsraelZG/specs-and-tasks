---
id: T-1047
title: "Migrar import de applyNodes de protocol para core"
status: obsolete
complexity: 2
target_agent: sonnet # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent
...
# T-1047 · Migrar import de applyNodes de protocol para core
...
- **[2026-07-14T12:29]** - *claude-fable* - `[Obsoleto]`: Premissa dissolvida: T-1047 era o follow-up da Decisão D2 de T-1046 ('consumir applyNodes de protocol para não bloquear em T-1033; trocar import quando T-1033 fechar'). O rework 2 de T-1033 (commit 11f8f73 no superapp) já moveu applyNodes para packages/core/src/rbsr/ e removeu o export de protocol — grep na master: zero imports de applyNodes via protocol. Não há import a migrar; D2 de T-1046 corrigida em §6 para consumir de @plataforma/core
