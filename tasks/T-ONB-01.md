---
id: T-ONB-01
title: "UI de Onboarding & Identidade (boas-vindas, seed com confirmação ativa, desbloqueio, convite, pareamento QR+SAS)"
status: draft:placeholder
complexity: 4
target_agent: frontend_agent # perfis: devops_agent, logic_agent, crypto_agent, frontend_agent
reviewer_agent: agile_reviewer
execution_mode: sequential # parallel | sequential
dependencies: ["T-104", "T-210", "T-705", "T-DS-05"] # IDs de tarefas que bloqueiam esta
ui: true
...
# T-ONB-01 · UI de Onboarding & Identidade (boas-vindas, seed com confirmação ativa, desbloqueio, convite, pareamento QR+SAS)
...
## 1. Objetivo
Construir o fluxo de onboarding do app produto: tela de boas-vindas (3 entradas: criar rede /
entrar com convite / entrar com identidade), criação de identidade (seed 12/24 palavras com
**confirmação ativa** — redigitar posições), desbloqueio (senha + biometria opcional), cerimônia
de convite (`ASSET:INVITE` — backend T-210 done) e pareamento de dispositivo QR+SAS (cripto T-705).
Consome as primitivas já entregues; esta task é só a superfície de UI.

## 2. Contexto RAG (Spec-Driven Development)
- [mecanica-de-telas.md §A2](../docs/mecanica-de-telas.md) — mecânica validada no mockup (boas-vindas, seed com confirmação ativa nas posições 2/5/9, desbloqueio com "esqueci a senha" local-first) + mecânica **[proposta]** para convite (estados válido/expirado/já-usado distintos) e pareamento QR+SAS (mesmo código SAS confirmado nos dois lados; cancelar aborta ambos).
- [inventario-de-telas.md §A2](../docs/inventario-de-telas.md) — composição exigida (telas, modais, estados: seed inválida, senha errada sem vazar timing, convite expirado/reutilizado, offline-retry).
- [diretrizes-ux.md §6](../docs/diretrizes-ux.md) — 7 estados obrigatórios por superfície.
