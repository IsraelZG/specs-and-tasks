...
**ideal** para um segundo par de olhos. A própria regra do AGENTS.md ("revisor de modelo diferente
...
Docs** (ver Paralelismo no AGENTS.md). Para cada task revisada, enfileire a intenção de commit:
